...
public record PlaceUpdateRequest(
        ...
        @DecimalMin(value = "-90.0", message = "-90.0 이상 입력")
        @DecimalMax(value = "90.0" , message = "90.0 이하 입력")
        BigDecimal latitude,

        @NotNull(message = "경도를 입력해주세요.")
        @DecimalMin(value = "-180.0", message = "최소 -180.0 이상 입력")
        @DecimalMax(value = "180.0", message = "최대 180.0 이하 입력")
        BigDecimal longitude,

        @NotBlank(message = "카테고리를 입력해주세요.")
        @Size(max = 50, message = "50자 이내로 적어주세요.")
        String category,
